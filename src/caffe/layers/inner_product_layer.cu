...
void InnerProductLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  //if (propagate_down[0]){
	 ...
	 // cudaMemcpy(topdiff, &top[0]->gpu_diff()[topdiffSize * 198819], sizeof(Dtype) * topdiffSize, cudaMemcpyDeviceToHost);
	 // cudaMemcpy(botdiff, &bottom[0]->gpu_diff()[botdiffSize * 198819], sizeof(Dtype) * botdiffSize, cudaMemcpyDeviceToHost);
