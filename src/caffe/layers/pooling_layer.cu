...
namespace caffe {
	...
	//nthreads : top 갯수
	//bottom_data : , num : bottom num, channels : 클래스 내부 채널수
	//height, width는 실제 인풋의 가로세로, pooled_height, pooled_width : 계산된 풀링영역
	//kernel_w, kernel_h : 풀링 패치의 사이즈, stride_h, stride_w : 풀링 스트라이드
	//pad_h, pad_w : 패딩 가로 세로 크기
...
__global__ void MaxPoolForward(const int nthreads,
  ...
  CUDA_KERNEL_LOOP(index, nthreads) {									//여기서 인덱스는 배치와 채널, 높이와 너비 모두 고려함
