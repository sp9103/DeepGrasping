...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Custom layer implemetation

template <typename Dtype>
class SpatialLayer : public Layer<Dtype> {
public:
	explicit SpatialLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	virtual inline const char* type() const { return "Spatial"; }
	//virtual inline int ExactNumBottomBlobs() const { return 1; }
	virtual inline int ExactNumTopBlobs() const { return 1; }
...
///////////////////////////////custom linear spatial layer///////////////////////////////////////////
template <typename Dtype>
class LinearSpatialLayer : public Layer<Dtype> {
public:
	explicit LinearSpatialLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	virtual inline const char* type() const { return "LinearSpatial"; }
	virtual inline int ExactNumBottomBlobs() const { return 1; }
	virtual inline int ExactNumTopBlobs() const { return 1; }
...
protected:
	...
	Blob<Dtype> sum_;
	Blob<Dtype> thresholdVal_;
	Blob<Dtype> linearOutput_;
};
...
protected:
	...
	Blob<Dtype>	index_;						//Pooling result & pooling index
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Custom layer implemetation
//bottom[0] = Depth image;
//bottom[1] = spatial position
...
template <typename Dtype>
class DistConcatLayer : public Layer<Dtype> {
public:
	explicit DistConcatLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	virtual inline const char* type() const { return "DistConcat"; }
	virtual inline int ExactNumTopBlobs() const { return 1; }
...
//Crumple Layer
//uvd-xyz net을 통과시키기 위해 뭉치고 펼치는 레이어
//delta도 펴줌
template <typename Dtype>
class CrumpleLayer : public Layer<Dtype> {
public:
	explicit CrumpleLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	virtual inline const char* type() const { return "Crumple"; }
	//virtual inline int ExactNumBottomBlobs() const { return 1; }
	virtual inline int ExactNumTopBlobs() const { return 1; }
...
//Kinect xyz->robot xyz로 변환하는 레이어
template <typename Dtype>
class LTLayer : public Layer<Dtype> {
public:
	explicit LTLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
class DepthSliceLayer : public Layer<Dtype> {
public:
	explicit DepthSliceLayer(const LayerParameter& param)
		: Layer<Dtype>(param) {}
	virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
		const vector<Blob<Dtype>*>& top);
	virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
	...
	virtual inline const char* type() const { return "DepthSlice"; }
	//virtual inline int ExactNumBottomBlobs() const { return 1; }
	virtual inline int ExactNumTopBlobs() const { return 1; }
